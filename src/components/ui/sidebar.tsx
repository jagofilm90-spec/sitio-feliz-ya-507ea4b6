...
>(({ asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...props }, ref) => {
  ...
  // Hide tooltip when sidebar is expanded (either by state or hover)
  const shouldHideTooltip = state !== "collapsed" || isMobile || isHovering;

  return (
    <Tooltip>
      <TooltipTrigger asChild>{button}</TooltipTrigger>
      <TooltipContent side="right" align="center" hidden={shouldHideTooltip} {...tooltip} />
    </Tooltip>
  );
});
