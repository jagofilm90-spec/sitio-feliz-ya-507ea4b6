...
| 5. Autonomía | 14/20 | Carlos puede crear pedidos desde celular sin Jose (wizard + offline). Norma puede ver/filtrar pedidos. Pero: SecretariaPedidosTab sin responsive = inutilizable en tablet. Autorización requiere entender alertas_precio. |
| **TOTAL** | **73/100** | |
...
3. SecretariaPedidosTab sin breakpoints responsive
4. 4 `as any` en Pedidos.tsx
...
| M04 Pedidos | 88% | 73% | **-15%** | 3 implementaciones divergentes, sin responsive secretaria |
...
- **UI funcional ≠ UI autónoma.** Secretaria necesita scroll horizontal para ver pedidos. Almacenista necesita capacitación para recepcionar. Contadora no puede generar P&L.
...
- Responsive en SecretariaPedidosTab (12 columnas sin breakpoints)
...
**SPRINT 3 (1 semana): M04 Pedidos → elevar de 73% a 80%**
- Agregar fecha_entrega al wizard vendedor y dialog admin
- Responsive secretaria pedidos
...
| M04 Pedidos | 73% | 85% | 12% | ⚠️ fecha_entrega + responsive + consistencia |
